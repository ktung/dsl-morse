...
public class App_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_g38wqt_d0(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstant_g38wqt_i3a(editorContext, node));
    editorCell.addEditorCell(this.createConstant_g38wqt_j3a(editorContext, node));
    editorCell.addEditorCell(this.createProperty_g38wqt_k3a(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createRefNode_g38wqt_f3a(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new App_Editor.lcdSingleRoleHandler_g38wqt_f3a(node, MetaAdapterFactory.getContainmentLink(0x5edee0cf46e149f9L, 0x971e6b9e2e5cae16L, 0x720eda988b034b2dL, 0x42c31259c640a3a4L, "lcd"), editorContext);
    return provider.createCell();
  }
  private class lcdSingleRoleHandler_g38wqt_f3a extends SingleRoleCellProvider {
    public lcdSingleRoleHandler_g38wqt_f3a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createRefNodeList_g38wqt_h3a(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new App_Editor.quizzesListHandler_g38wqt_h3a(node, "quizzes", editorContext);
    EditorCell_Collection editorCell = handler.createCells(editorContext, new CellLayout_Indent(), false);
  ...
  private static class quizzesListHandler_g38wqt_h3a extends RefNodeListHandler {
    public quizzesListHandler_g38wqt_h3a(SNode ownerNode, String childRole, EditorContext context) {
      super(ownerNode, childRole, context, false);
    }
    public SNode createNodeToInsert(EditorContext editorContext) {
      SNode listOwner = super.getOwner();
  ...
  private EditorCell createConstant_g38wqt_i3a(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "");
    editorCell.setCellId("Constant_g38wqt_i3a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, 0, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createProperty_g38wqt_k3a(EditorContext editorContext, SNode node) {
    CellProviderWithRole provider = new PropertyCellProvider(node, editorContext);
