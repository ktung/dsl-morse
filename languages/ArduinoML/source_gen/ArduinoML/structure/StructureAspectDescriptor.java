...
public class StructureAspectDescriptor extends BaseStructureAspectDescriptor {
  ...
  public StructureAspectDescriptor() {
    ...
    myIndexMap.put(myConceptQuizz.getId(), 5);
    myIndexMap.put(myConceptSensor.getId(), 6);
    myIndexMap.put(myConceptState.getId(), 7);
    myIndexMap.put(myConceptTransition.getId(), 8);
    myIndexMap.put(myConceptWord.getId(), 9);
  }

  @Override
  public Collection<ConceptDescriptor> getDescriptors() {
    return Arrays.asList(myConceptAction, myConceptActuator, myConceptApp, myConceptBrick, myConceptLcd, myConceptQuizz, myConceptSensor, myConceptState, myConceptTransition, myConceptWord);
  }
